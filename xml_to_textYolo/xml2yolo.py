...
addxmlpath = parentpath + 'fire-dataset/train/annotations' #"Directory path with XML files"
addimgpath = parentpath + 'fire-dataset/train/images' #"Directory path with IMG files"
